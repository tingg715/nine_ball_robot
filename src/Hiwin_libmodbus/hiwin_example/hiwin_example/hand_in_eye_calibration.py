...
# CALI_POSE = [[0.0, 368.0, 293.5, -180.0, 0.0, 90.0],
#              [138.8, 368.0, 182.2, -166.2, 0.4, 88.1],
#              [-0.0, 493.7, 160.6, -180.0, 19.4, 90.0],
#              [-179.5, 454.1, 103.4, 150.7, 14.3, 90.0],
#              [-0.0, 410.3, 139.0, 165.4, 17.4, 85.5],
#              [68.4, 281.6, 105.0, 180.0, -10.4, 90.0],
#              [8.0, 349.4, 80.1, 161.9, 0.0, 90.0],
#              [111.1, 273.2, 255.3, 168.8, -2.1, 89.54],
#              [-0.0, 416.0, 103.3, -169.5, 13.3, 91.1],
#              [-211.6, 292.6, 146.4, 151.8, -6.4, 93.4],
#              [173.7, 368.0, 106.9, -154.4, 0.0, 90.0],
#              [0.0, 368.0, 110.3, 165.6, 2.1, 90.7],
#              [-69.6, 464.4, 128.3, -180.0, 25.0, 90.0],
#              [143.57, 351.0, 117.1, -154.0, 0.0, 90.0],
#              [180.4, 450.5, 106.8, -157.9, 13.0, 90.0],
#              [-136.1, 276.6, 121.4, 163.3, 2.4, 90.0],
#              [0.0, 372.1, 51.3, -162.7, 5.7, 92.4],
#              [143.5, 425.4, 122.5, -168.6, 16.2, 93.2],
#              [-124.9, 413.9, 79.5, 162.0, 12.8, 92.4],
#              [161.4, 396.5, 128.4, -159.5, 11.5, 94.2],
#              [107.8, 368.0, 124.9, -159.7, 0.0, 90.0],
#              [154.3, 303.4, 53.1, -155.6, 0.0, 90.0]]
             
CALI_POSE = [[0.0, 368.0, 293.5, -180.0, 0.0, 90.0],
             [0.0, 453.9, 182.6, -180.0, 5.1, 90.0],
             [0.0, 367.5, 142.9, -180.0, 14.53, 90.0],
             [11.1, 367.8, 143.5, 172.9, 14.6, 91.5],
             [17.6, 498.5, 100.2, 168.5, 21.6, 90.92],
             [-16.1, 35.07, 205.6, -169.2, 15.6, 90.0],
             [140.7, 422.3, 168.6, -174.3, 18.7, 70.4],
             [140.8, 423.4, 177.2, 159.1, 18.3, 112.3],
             [0.4, 390.55, 90.9, 179.6, 9.8, 90.14],
             [-83.3, 491.5, 138.8, 162.6, 20.4, 102.5],
             [0.0, 474.0, 56.4, 180.0, 33.7, 90.0],
             [93.1, 455.9, 125.4, -157.5, 25.4, 74.3],
             [0.0, 280.3, 260.4, -180.0, 3.8, 90.0],
             [59.9, 320.2, 221.8, -165.1, 42.7, 75.4],
